...
const ChatHeader = ({ className, children, style, ...props }: ChatHeaderProps) => {
  return (
    <div
      ...
      style={{
        backgroundColor: "color-mix(in srgb, var(--chat-header) 32%, transparent)",
...
const ChatHeaderActions = () => {
  return (
    <div data-slot="chat-header-actions" className="flex shrink-0 items-center gap-1">
